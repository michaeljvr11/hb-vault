...
Snapshot (refreshed 2026-06-30, after Sm1kSNO8 safe category delete / PR #24)
- **76** commits (2026-06-11 → 2026-06-30); **68** carry the AI-authorship trailer (**89%**)
- **+37 046 / −2 597** authored lines across **374** files (generated lockfiles excluded)
- **36** test specs (API **10** · Web **26**)
